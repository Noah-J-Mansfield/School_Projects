; CpS 230 Project: Robert Meyer (rmeye154) & Noah Mansfield(nmans433)
;---------------------------------------------------
...
; Embedded data
boot_msg:	db	"CpS 230: Project Code Name Pong", 13, 10
		db	"By Robert & Noah", 13, 10, 0
prompt: db "Press Anykey To Boot:", 13, 10 ,0
...
main:
	...
	mov dx, boot_disk
	call puts
	; TODO: use BIOS raw disk I/O to load sector 
	; 2 from disk number <boot_disk> into memory at 0800:0000h (retry on failure)
	_bootloop:
	mov ax, 0x0800
	mov es, ax
